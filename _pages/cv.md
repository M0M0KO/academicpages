...
<div style="text-align: center; margin-bottom: 1.5em;">
  <p style="font-size: 1.1em; color: #494e52; font-style: italic; max-width: 800px; margin: 0 auto;">
    Focusing on learning deep learning methodologies for medical image analysis and working to transition into embodied intelligence research
  </p>
</div>
...
<div class="education">
  ...
  <div class="education-entry">
    ...
    <ul>
      ...
      <li>Relevant Coursework: Data Structures and Algorithms, Python Programming, Data Analysis</li>
...
<div class="experience">
  <div class="experience-entry">
    ...
    <ul>
      <li>Participated in developing medical image preprocessing software for clinical applications, contributing to software copyright registration</li>
      <li>Assisted in designing deep learning models for leukemia diagnosis based on tongue image analysis</li>
...
<div class="learning-focus">
  ...
  <div class="learning-grid">
    ...
    <div class="learning-item"><i class="fas fa-project-diagram"></i>Multi-modal integration for embodied AI</div>
    <div class="learning-item"><i class="fas fa-gamepad"></i>Reinforcement learning for physical tasks</div>
    <div class="learning-item"><i class="fas fa-users"></i>Human-robot interaction principles</div>
  ...
  <div class="resources-grid">
    <div class="resource-item">
      ...
      <span>"Modern Robotics: Mechanics, Planning, and Control" by Kevin Lynch and Frank Park</span>
    </div>
    <div class="resource-item">
      <i class="fas fa-book-open"></i>
      <span>"Reinforcement Learning: An Introduction" by Richard S. Sutton and Andrew G. Barto</span>
    </div>
    <div class="resource-item">
      <i class="fas fa-laptop-code"></i>
      <span>Stanford CS231n: Convolutional Neural Networks for Visual Recognition</span>
    </div>
    <div class="resource-item">
      <i class="fas fa-laptop-code"></i>
      <span>UC Berkeley CS285: Deep Reinforcement Learning</span>
    </div>
  </div>
</div>
...
<style>
  ...
  .learning-item i, .resource-item i {
    margin-right: 0.5em;
    color: #494e52;
  }
